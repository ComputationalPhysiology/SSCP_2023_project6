...
The model is dynamic, but it is rendered approximately isometric 
by setting Kse=100000 (stiffness of the series elastic element).
"""
...
for lmbda in np.linspace(0.9,1.1,5):
    ...
    p = land_model.init_parameter_values(lmbda_set=lmbda,Kse=100000,Ca_amplitude=0.6, Ca_diastolic=0.17, tau1=75, tau2=175)
